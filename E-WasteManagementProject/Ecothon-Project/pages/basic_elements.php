...
if(isset($_POST["registerbtn"]))
{
  ...
  $qry = "INSERT INTO `ewm`(`id`, `category`, `product_name`, `product_description`, `expected_price`, `pickup_address`, `state`, `city`, `contact`, `photo`) VALUES (NULL,'$cat','$name','$desc','$price','$add','$state','$city','$contact','$filename')";
}else {
    // If no file is selected, insert into the database without a photo
    $qry = "INSERT INTO `ewm`(`id`, `category`, `product_name`, `product_description`, `expected_price`, `pickup_address`, `state`, `city`, `contact`) VALUES (NULL,'$cat','$name','$desc','$price','$add','$state','$city','$contact')";
  }
            ...
            <li class="nav-item nav-profile">
              <a href="#" class="nav-link">
                ...
                <div class="nav-profile-text d-flex flex-column">
                  <span class="font-weight-bold mb-2">Om</span>
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" method="post">
                      <div class="form-group">
                        <label for="exampleSelectGender">Choose Product Category</label>
                        <select class="form-control" id="category" name="category">
                          <option>Camera</option>
                          <option>Television</option>
                          <option>Refregirator</option>
                          <option>Battries</option>
                      ...
                      <div class="form-group">
                        <label for="exampleInputPassword4">Expected Price</label>
                      ...
                      <div class="form-group">
                        <label for="exampleInputPassword4">Pickup Address</label>
                        <input type="text" class="form-control" id="pickup_address" name="pickup_address" placeholder="">
                      </div>

                      <div class="form-group">

                     <label for="exampleSelectGender">Choose State</label>
                      ...
                      <button type="submit" class="btn btn-gradient-primary me-2" name="registerbtn">Submit</button>
                      <button class="btn btn-light">Cancel</button>
                    </form>
                  </div>
                </div>
